...
namespace Polleria.Migrations
{
    ...
    [Migration("20260413212018_documentstype")]
    partial class documentstype
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 21, 20, 8, 431, DateTimeKind.Utc).AddTicks(3474),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 13, 21, 20, 8, 431, DateTimeKind.Utc).AddTicks(3485),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 21, 20, 8, 431, DateTimeKind.Utc).AddTicks(3490),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
