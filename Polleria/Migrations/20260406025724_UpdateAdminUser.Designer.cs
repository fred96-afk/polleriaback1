...
namespace Polleria.Migrations
{
    ...
    [Migration("20260406025724_UpdateAdminUser")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 6, 2, 57, 16, 646, DateTimeKind.Utc).AddTicks(1864),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 6, 2, 57, 16, 646, DateTimeKind.Utc).AddTicks(1885),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 6, 2, 57, 16, 646, DateTimeKind.Utc).AddTicks(1893),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
