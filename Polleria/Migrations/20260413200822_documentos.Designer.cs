...
namespace Polleria.Migrations
{
    ...
    [Migration("20260413200822_documentos")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 20, 8, 13, 963, DateTimeKind.Utc).AddTicks(1893),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 13, 20, 8, 13, 963, DateTimeKind.Utc).AddTicks(1902),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 20, 8, 13, 963, DateTimeKind.Utc).AddTicks(1909),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
