...
namespace Polleria.Migrations
{
    ...
    [Migration("20260405224805_seeds1")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 5, 22, 48, 1, 447, DateTimeKind.Utc).AddTicks(789),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 5, 22, 48, 1, 447, DateTimeKind.Utc).AddTicks(797),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 5, 22, 48, 1, 447, DateTimeKind.Utc).AddTicks(802),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
