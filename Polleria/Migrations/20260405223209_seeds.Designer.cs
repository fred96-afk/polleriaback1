...
namespace Polleria.Migrations
{
    ...
    [Migration("20260405223209_seeds")]
    partial class seeds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 5, 22, 32, 6, 602, DateTimeKind.Utc).AddTicks(3166),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 5, 22, 32, 6, 602, DateTimeKind.Utc).AddTicks(3178),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 5, 22, 32, 6, 602, DateTimeKind.Utc).AddTicks(3186),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
