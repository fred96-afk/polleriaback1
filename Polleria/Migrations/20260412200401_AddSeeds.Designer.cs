...
namespace Polleria.Migrations
{
    ...
    [Migration("20260412200401_AddSeeds")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 12, 20, 4, 0, 113, DateTimeKind.Utc).AddTicks(7638),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 12, 20, 4, 0, 113, DateTimeKind.Utc).AddTicks(7644),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 12, 20, 4, 0, 113, DateTimeKind.Utc).AddTicks(7648),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
