...
namespace Polleria.Migrations
{
    ...
    [Migration("20260413013426_FixRoleNames")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 1, 34, 19, 962, DateTimeKind.Utc).AddTicks(276),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 13, 1, 34, 19, 962, DateTimeKind.Utc).AddTicks(285),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 1, 34, 19, 962, DateTimeKind.Utc).AddTicks(290),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
