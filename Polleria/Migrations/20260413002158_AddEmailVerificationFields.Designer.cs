...
namespace Polleria.Migrations
{
    ...
    [Migration("20260413002158_AddEmailVerificationFields")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 0, 21, 56, 689, DateTimeKind.Utc).AddTicks(3449),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 13, 0, 21, 56, 689, DateTimeKind.Utc).AddTicks(3455),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 0, 21, 56, 689, DateTimeKind.Utc).AddTicks(3458),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
