...
namespace Polleria.Migrations
{
    ...
    [Migration("20260406003124_seeds2")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 6, 0, 31, 18, 140, DateTimeKind.Utc).AddTicks(5059),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 6, 0, 31, 18, 140, DateTimeKind.Utc).AddTicks(5071),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 6, 0, 31, 18, 140, DateTimeKind.Utc).AddTicks(5079),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
