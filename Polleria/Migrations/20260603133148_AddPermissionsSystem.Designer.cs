...
namespace Polleria.Migrations
{
    ...
    [Migration("20260603133148_AddPermissionsSystem")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 6, 3, 13, 31, 46, 455, DateTimeKind.Utc).AddTicks(3061),
                            PaymentStatus = 0,
                            Status = 0,
                            TotalAmount = 65.0m,
                            Type = 0,
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 6, 3, 13, 31, 46, 455, DateTimeKind.Utc).AddTicks(3067),
                            PaymentStatus = 0,
                            Status = 0,
                            TotalAmount = 35.0m,
                            Type = 0,
                        ...
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 6, 3, 13, 31, 46, 455, DateTimeKind.Utc).AddTicks(3071),
                            PaymentStatus = 0,
                            Status = 0,
                            TotalAmount = 20.0m,
                            Type = 0,
