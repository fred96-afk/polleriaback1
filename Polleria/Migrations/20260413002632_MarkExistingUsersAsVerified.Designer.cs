...
namespace Polleria.Migrations
{
    ...
    [Migration("20260413002632_MarkExistingUsersAsVerified")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 0, 26, 30, 544, DateTimeKind.Utc).AddTicks(1748),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 13, 0, 26, 30, 544, DateTimeKind.Utc).AddTicks(1754),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 13, 0, 26, 30, 544, DateTimeKind.Utc).AddTicks(1758),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
