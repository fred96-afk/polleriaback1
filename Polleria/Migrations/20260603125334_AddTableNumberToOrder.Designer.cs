...
namespace Polleria.Migrations
{
    ...
    [Migration("20260603125334_AddTableNumberToOrder")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 6, 3, 12, 53, 32, 600, DateTimeKind.Utc).AddTicks(6746),
                            PaymentStatus = 0,
                            Status = 0,
                            TotalAmount = 65.0m,
                            Type = 0,
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 6, 3, 12, 53, 32, 600, DateTimeKind.Utc).AddTicks(6752),
                            PaymentStatus = 0,
                            Status = 0,
                            TotalAmount = 35.0m,
                            Type = 0,
                        ...
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 6, 3, 12, 53, 32, 600, DateTimeKind.Utc).AddTicks(6755),
                            PaymentStatus = 0,
                            Status = 0,
                            TotalAmount = 20.0m,
                            Type = 0,
