...
namespace Polleria.Migrations
{
    ...
    [Migration("20260412200900_final2")]
            ...
            modelBuilder.Entity("DbModel.Tables.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            DeliveryUserId = 3,
                            OrderDate = new DateTime(2026, 4, 12, 20, 8, 58, 731, DateTimeKind.Utc).AddTicks(1349),
                            TotalAmount = 65.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            OrderDate = new DateTime(2026, 4, 12, 20, 8, 58, 731, DateTimeKind.Utc).AddTicks(1355),
                            TotalAmount = 35.0m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            OrderDate = new DateTime(2026, 4, 12, 20, 8, 58, 731, DateTimeKind.Utc).AddTicks(1358),
                            TotalAmount = 20.0m,
                            UserId = 1
                        });
                });
